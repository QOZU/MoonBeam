...
#[derive(Debug)]
pub struct MoonBeamProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MoonBeamProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MoonBeam processing");
    
    let mut processor = MoonBeamProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MoonBeamProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MoonBeamProcessor::new(false);
